...
public class MainIPL {
    ...
    static void ReadAndCensorJsonFile() {
        try {
            ...
            List<IPLData> iplDataList = objectmapper.readValue(
                    new File("src/main/java/com/bridgelabz/iplcensor/Ipldata.json"),
            ...
            objectmapper.writerWithDefaultPrettyPrinter().writeValue(
                    new File("src/main/java/com/bridgelabz/iplcensor/Ipldata_censored.json"),
                    iplDataList
            );
    ...
    static void ReadAndCensorCSVFile() {
        try {
            ObjectMapper objectmapper = new ObjectMapper();
            CSVReader reader = new CSVReader(new FileReader("src/main/java/com/bridgelabz/iplcensor/ipldata.csv"));
            CSVWriter writer = new CSVWriter(new FileWriter("src/main/java/com/bridgelabz/iplcensor/iplcensore.csv"));
